...
class ZTrack : public Track{
	public:

	ZTrack();

	// calculate the energy loss of a cosmic muon inside a module, 
	// assuming that the track is fully contained in the y-z plane 
	// and that it only enters and leaves each module through the 
	// surfaces parallel to the x-y plane
